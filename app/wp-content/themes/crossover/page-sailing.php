<?php
/*
Template Name: Sailing Page Template
*/
...
<main id="sailing">
	...
	<section id="hero">
		<div class="wrapper">
			...
			<a href="#gallery" class="btn" title="Gallery"><?=get_field('hero_button_1_label')?></a>
			<a href="#questions" class="btn" title="Questions and Answers"><?=get_field('hero_button_2_label')?></a>
			<a href="/prijavi-se" id="red-button">Apply Now!</a>
		</div>
	</section>
