<?php 
/*
Template Name: DaVinci Resolve Page Template
*/
...
<main id="davinci">
    ...
    <section id="first">
        <div class="wrapper">
            ...
            <div class="images">
                <div class="large" style="background-image: url('<?=get_field('large_image')['sizes']['hero']?>');">
                    <img src="<?=get_field('large_image')['sizes']['hero']?>" alt="<?=get_field('large_image')['alt']?>" class="large">
                </div>
